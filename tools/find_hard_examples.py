...
from utils.dataset import GaitTrialInstance
...
def main():
    ...
    model.load_state_dict(
        torch.load(
            'backend/algorithms/gait_basic/gait_study_semi_turn_time/weights/semi_vanilla_v2/gait-turn-time.pth',  # noqa
    ...
    for folder in os.listdir('/data/'):
        potential_paths_to_npz = glob.glob(
            os.path.join('/data/', folder, 'out', '3d', '*.mp4.npy'),
        )
